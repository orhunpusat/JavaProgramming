...
public class EmployeeObjects {
    public static void main(String[] args) {
        ...
        //Person person = new Person("Josh", 35, 'M'); // We can not create because Person Class is ABSTRACT
        //Employee employee = new Employee("Ali",30,'M',42,"SDET",145000.00);// We can not create because Employee Class is ABSTRACT
