...
public class EvenlyDivisible {
    public static void main(String[] args) {
        int number = 100;
        boolean divisibleBy2 = number % 2 ==0; //if the remainder of a number divided by 2 is zere, then it's evenly divisible by 2
...
/*
Created a class called EvenlyDivisible, and
