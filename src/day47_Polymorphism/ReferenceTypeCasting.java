...
public class ReferenceTypeCasting {
    ...
    public static void main(String[] args) {
       ...
       // Shape shape = (Shape) new Circle(4); // upcasting
        ...
        //( (Dog) animal2).bark(); //animal2 is a cat object so we can not use bark method
        ...
        //((Tester) employee).unitTest(); // class cast exception
        //((Developer) employee).unitTest();// class cast exception
