...
public class ArrayListExamplesWithMethods {
    public static void main(String[] args) {
        ...
        //add(Object)
        //create an arrayList thet hold string objects
        ...
        //Why in arrayListwe have to define iindex at the methods?
        //index based collection,keep track of the order

        //get (index) --> return the element at the given index
        System.out.println("cities.get(0)= "+cities.get(0)); //London
        String mycity = cities.get(1);
        System.out.println(mycity);//Istanbul
