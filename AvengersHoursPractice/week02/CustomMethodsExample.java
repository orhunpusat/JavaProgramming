...
public class CustomMethodsExample {
    public static void main(String[] args) {
        ...
        //    double sumThree = add(5.5,5); this one is calling void method, it does not return anything
    ...
    public static void add(double x,int y){ // same name with different parameters
